package com.eb.esop.common.util;
...
public class DateUtil {
	...
	public static String formatDateEnSHORT() {
		SimpleDateFormat format = new SimpleDateFormat(SHORT_EN_FORMAT);
		return format.format(new Date());
	}
	...
	public static String getLastMonths(String curDate) {
		...
		String nextDate = "";
		if (firstMonthChar.equals("0")) {// 月小于10
	...
	/**
	 * @param date
	 *            时间字符串 yyyy-MM-dd或yyyyMM或yyyy-MM
	 * @param n
	 *            对date月份的操作月数 为正数 就是向后加N个月 为负数就是向前+n个月
